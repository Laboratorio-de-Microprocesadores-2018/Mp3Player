...
#define BOARD_SDHC_CD_GPIO_BASE 		BOARD_INITPINS_SD_DETECT_GPIO

#ifndef BOARD_SDHC_CD_GPIO_PIN
#define BOARD_SDHC_CD_GPIO_PIN 			BOARD_INITPINS_SD_DETECT_PIN
#endif

#define BOARD_SDHC_CD_PORT_BASE 		BOARD_INITPINS_SD_DETECT_PORT

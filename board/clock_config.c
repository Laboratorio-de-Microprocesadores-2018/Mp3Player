...
#define RTC_RTC32KCLK_PERIPHERALS_DISABLED                0U  /*!< RTC32KCLK to other peripherals: disabled */
...
/*******************************************************************************
 * Variables for BOARD_ClockInternal configuration
 ******************************************************************************/
const mcg_config_t mcgConfig_BOARD_ClockInternal =
    {
...
const sim_clock_config_t simConfig_BOARD_ClockInternal =
    {
        .pllFllSel = SIM_PLLFLLSEL_MCGFLLCLK_CLK, /* PLLFLL select: MCGFLLCLK clock */
        .er32kSrc = SIM_OSC32KSEL_OSC32KCLK_CLK,  /* OSC32KSEL select: OSC32KCLK clock */
        .clkdiv1 = 0x110000U,                     /* SIM_CLKDIV1 - OUTDIV1: /1, OUTDIV2: /1, OUTDIV3: /2, OUTDIV4: /2 */
    };
const osc_config_t oscConfig_BOARD_ClockInternal =
    {
...
/*******************************************************************************
 * Code for BOARD_ClockInternal configuration
 ******************************************************************************/
void BOARD_ClockInternal(void)
{
    ...
    CLOCK_SetInternalRefClkConfig(mcgConfig_BOARD_ClockInternal.irclkEnableMode,
                                  mcgConfig_BOARD_ClockInternal.ircs, 
                                  mcgConfig_BOARD_ClockInternal.fcrdiv);
    /* Set MCG to FEI mode. */
#if FSL_CLOCK_DRIVER_VERSION >= MAKE_VERSION(2, 2, 0)
    CLOCK_BootToFeiMode(mcgConfig_BOARD_ClockInternal.dmx32,
                        mcgConfig_BOARD_ClockInternal.drs,
                        CLOCK_CONFIG_FllStableDelay);
#else
    CLOCK_BootToFeiMode(mcgConfig_BOARD_ClockInternal.drs,
                        CLOCK_CONFIG_FllStableDelay);
#endif
    /* Set the clock configuration in SIM module. */
    CLOCK_SetSimConfig(&simConfig_BOARD_ClockInternal);
    /* Set SystemCoreClock variable. */
    SystemCoreClock = BOARD_CLOCKINTERNAL_CORE_CLOCK;
}
...
/*******************************************************************************
 * Variables for BOARD_ClockExternal configuration
 ******************************************************************************/
const mcg_config_t mcgConfig_BOARD_ClockExternal =
    {
...
const sim_clock_config_t simConfig_BOARD_ClockExternal =
    {
...
/*******************************************************************************
 * Code for BOARD_ClockExternal configuration
 ******************************************************************************/
void BOARD_ClockExternal(void)
{
    ...
    CLOCK_InitOsc0(&oscConfig_BOARD_ClockExternal);
    CLOCK_SetXtal0Freq(oscConfig_BOARD_ClockExternal.freq);
    /* Configure FLL external reference divider (FRDIV). */
    CLOCK_CONFIG_SetFllExtRefDiv(mcgConfig_BOARD_ClockExternal.frdiv);
    /* Set MCG to PEE mode. */
    CLOCK_BootToPeeMode(mcgConfig_BOARD_ClockExternal.oscsel,
                        kMCG_PllClkSelPll0,
                        &mcgConfig_BOARD_ClockExternal.pll0Config);
    /* Set the clock configuration in SIM module. */
    CLOCK_SetSimConfig(&simConfig_BOARD_ClockExternal);
    /* Set SystemCoreClock variable. */
    SystemCoreClock = BOARD_CLOCKEXTERNAL_CORE_CLOCK;
    /* Enable USB FS clock. */
...
/*******************************************************************************
 * Variables for BOARD_ClockSleep configuration
 ******************************************************************************/
const mcg_config_t mcgConfig_BOARD_ClockSleep =
    {
...
const sim_clock_config_t simConfig_BOARD_ClockSleep =
    {
        .pllFllSel = SIM_PLLFLLSEL_MCGFLLCLK_CLK, /* PLLFLL select: MCGFLLCLK clock */
        .er32kSrc = SIM_OSC32KSEL_OSC32KCLK_CLK,  /* OSC32KSEL select: OSC32KCLK clock */
        .clkdiv1 = 0x140000U,                     /* SIM_CLKDIV1 - OUTDIV1: /1, OUTDIV2: /1, OUTDIV3: /2, OUTDIV4: /5 */
    };
const osc_config_t oscConfig_BOARD_ClockSleep =
    {
        .freq = 0U,                               /* Oscillator frequency: 0Hz */
        .capLoad = (OSC_CAP0P),                   /* Oscillator capacity load: 0pF */
        .workMode = kOSC_ModeExt,                 /* Use external clock */
...
/*******************************************************************************
 * Code for BOARD_ClockSleep configuration
 ******************************************************************************/
void BOARD_ClockSleep(void)
{
    ...
    CLOCK_BootToBlpiMode(mcgConfig_BOARD_ClockSleep.fcrdiv,
                         mcgConfig_BOARD_ClockSleep.ircs,
                         mcgConfig_BOARD_ClockSleep.irclkEnableMode);
    /* Set the clock configuration in SIM module. */
    CLOCK_SetSimConfig(&simConfig_BOARD_ClockSleep);
    /* Set VLPR power mode. */
    ...
    /* Set SystemCoreClock variable. */
    SystemCoreClock = BOARD_CLOCKSLEEP_CORE_CLOCK;
}
